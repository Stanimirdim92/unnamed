...
if (version_compare("5.5.28", PHP_VERSION, '>')) {
    throw new \Exception(sprintf('Your server is running PHP version <b>%1$s</b>, but the system <b>%2$s</b> requires at least <b>%3$s</b> or higher</b>.', PHP_VERSION, "0.0.18", "5.5.28"));
}
